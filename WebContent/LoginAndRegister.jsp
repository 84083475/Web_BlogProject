...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login"
	    <c:choose>
			<c:when test="${l==1 }">style="display: block; height: 235px;"</c:when>
			<c:when test="${l==2 }">style="display: none; height: 235px;"</c:when>
			<c:otherwise>style="display: block; height: 235px;"</c:otherwise>
		</c:choose>
  ...
  <!--注册-->
    <div class="qlogin" id="qlogin"
    	<c:choose>
			<c:when test="${l==1 }">style="display: none; "</c:when>
			<c:when test="${l==2 }">style="display: block; "</c:when>
        		...
        		<li>
                 <label for="qq" class="input-tips2">账号：</label>
                    <div class="inputOuter2">
                        ...
                        <input type="text" id="qq" name="userid" maxlength="10" class="inputstyle2"/>
                    </div>
